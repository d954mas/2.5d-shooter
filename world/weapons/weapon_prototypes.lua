...
M.TARGET_HASHES = COMMON.read_only{
	ENEMIES = {COMMON.HASHES.MSG_PHYSICS_GROUP_ENEMY,COMMON.HASHES.MSG_PHYSICS_GROUP_OBSTACLE},
	PLAYER = {COMMON.HASHES.MSG_PHYSICS_GROUP_PLAYER,COMMON.HASHES.MSG_PHYSICS_GROUP_OBSTACLE},
}
