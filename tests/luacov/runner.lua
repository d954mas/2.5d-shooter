...
local stats = require("tests.luacov.stats")
local util = require("tests.luacov.util")
local hook = require("tests.luacov.hook")
local reporter = require("tests.luacov.reporter")
runner.defaults = require("tests.luacov.defaults")
