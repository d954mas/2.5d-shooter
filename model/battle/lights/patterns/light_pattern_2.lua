...
function Pattern:initialize(...)
	...
	self.start_light.h = 0
	self.start_light.s = 0
	self:add_animation()
end

function Pattern:add_animation()
	local start_hsv = COMMON.LUME.clone_deep(self.start_light) ;start_hsv.v = 0.7
	local color_2 = COMMON.LUME.clone_deep(start_hsv) ;color_2.v = 0.4
	local color_3 = COMMON.LUME.clone_deep(start_hsv) ;color_3.v = 0.6
	local color_4 = COMMON.LUME.clone_deep(start_hsv) ;color_4.v = 0.75
	local color_5 = COMMON.LUME.clone_deep(start_hsv) ;color_5.v = 0.5
