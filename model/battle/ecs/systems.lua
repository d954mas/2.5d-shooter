...
function M.load()
	...
	M.DrawBulletSystem = require "model.battle.ecs.systems.draw_bullet_system"
	...
	M.PhysicsCollisionBulletPlayerSystem = require "model.battle.ecs.systems.physics_collision_bullet_player_system"
